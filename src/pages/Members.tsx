          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all duration-200"
              >
                {seasons.map(season => (
