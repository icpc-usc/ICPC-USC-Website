  ...
  return (
    <div className="text-gray-900 dark:text-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-200/95 via-purple-200/90 to-indigo-200/95 dark:from-blue-900/100 dark:via-purple-900/90 dark:to-indigo-900/100"></div>
