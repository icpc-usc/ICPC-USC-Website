...
const logo_blue = "https://res.cloudinary.com/dcatuev0j/image/upload/v1758682355/logo_blue_abehut.png";
...
export function Header({
  ...
  const isCurrentPath = (path: string) =>
    ...
    (path === "/training" && location.pathname.startsWith("/training"));
        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg sm:text-xl font-bold text-blue-800 dark:text-white">
                ICPC USC
              </h1>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex space-x-6 xl:space-x-8">
            {navigation.map((item) => (
              <div
                ...
                className="relative"
                onMouseEnter={() =>
                  item.hasDropdown && setIsTrainingDropdownOpen(true)
                }
                onMouseLeave={() =>
                  item.hasDropdown && setIsTrainingDropdownOpen(false)
                }
              >
                <button
                  onClick={
