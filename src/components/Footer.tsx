          ...
          <div className="animate-fadeInRight animate-delay-300">
            ...
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">University of Sadat City</span>
              </div>
              <div className="flex items-center space-x-2">
                <Github className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
                <a className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1" href="https://github.com/icpc-usc" target="_blank">icpc-usc</a>
              </div>
             <div className="flex items-center space-x-2">
                <Facebook className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
                <a className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1" href="https://www.facebook.com/profile.php?id=100066890643130" target="_blank">facebook page</a>
              </div>
            </div>
          </div>
        </div>
